...
public class CreditsController : MonoBehaviour {
    ...
    private StringStringDictionary languageDict;
    ...
    private void Start() {
        ...
        languageDict = displayInfo.currentLanguage.languageDict;
    }
    ...
    private void Update() {
        ...
        if (timer > 102) {
            ...
            creditsTitle2.text = languageDict["specialThanks"]; // "SPECIAL THANKS";
            credits2.text = languageDict["thanksInfo"]; // "Gateway Games LARP";
            ...
            credits2.DOFade(0, 3);
            creditsTitle2.DOFade(0, 3);
            creditsTitle1.text = languageDict["music"]; // "MUSIC";
            credits1.text = languageDict["musicInfo"].Replace("\\n", "\n"); ; // "Parallax Mix (New) 4 by Hayden Folker\nHorde Of Geese by Alexander Nakarada (www.creatorchords.com)\nGame Over - Repeating Dream by Yakikaze\nAllegretto by B. Godard, performed by Ion Bogdan Stefanescu";
            ...
            credits1.DOFade(0, 3);
            creditsTitle1.DOFade(0, 3);
            creditsTitle2.text = languageDict["sound"]; // "SOUND";
            credits2.text = languageDict["soundInfo"].Replace("\\n", "\n"); ; // "Dialog Text Sound Effects by Alan Dalcastagne\nRPG Essentials Sound Effects by leohpaz\nSpotlight by realsoundFX\nBig switch sound effect by Her Ses";
            creditsTitle2.DOFade(1, 3);
            credits2.DOFade(1, 3);
            ...
            credits2.DOFade(0, 3);
            creditsTitle2.DOFade(0, 3);
            creditsTitle1.text = languageDict["tools"]; //"TOOLS";
            credits1.text = languageDict["toolsInfo"].Replace("\\n", "\n"); ; //"SerializableDictionary by Mathieu Le Ber\nDOTween by Demigiant\nxNode by Siccity";
            creditsTitle1.DOFade(1, 3);
            credits1.DOFade(1, 3);
            ...
            credits1.DOFade(0, 3);
            creditsTitle1.DOFade(0, 3);
            creditsTitle2.text = languageDict["uiAssets"]; // "UI ASSETS";
            credits2.text = languageDict["uiInfo"].Replace("\\n", "\n"); ; //"SteampunkUI by Gentleland";
            creditsTitle2.DOFade(1, 3);
            credits2.DOFade(1, 3);
            ...
            credits2.DOFade(0, 3);
            creditsTitle2.DOFade(0, 3);
            creditsTitle1.text = languageDict["bgArt"]; //"BACKGROUND ART";
            credits1.text = languageDict["artInfo"].Replace("\\n", "\n"); ;//"2D Neighborhood by Afnan Mahin\nEn scène by Anne Contet";
            creditsTitle1.DOFade(1, 3);
            credits1.DOFade(1, 3);
            ...
            credits1.DOFade(0, 3);
            creditsTitle1.DOFade(0, 3);
            creditsTitle2.text = languageDict["bgTiles"]; //"BACKGROUND TILES";
            credits2.text = languageDict["tilesInfo"].Replace("\\n", "\n"); //"Medieval pixel art asset by Blackspire\nClassic Legacy Pack - Village by Anomaly Pixel";
            creditsTitle2.DOFade(1, 3);
            credits2.DOFade(1, 3);
            eventsTriggered[1] = true;
        }
        else if (timer > 2 && !eventsTriggered[0]) {
            creditsTitle1.text = languageDict["gameBy"]; //"PROGRAMMING, DESIGN, SPRITES, WRITING";
            credits1.text = "Eileen Carette"; //no need to localize my name
            creditsTitle1.DOFade(1, 3);
            credits1.DOFade(1, 3);
